...
public class Tree {
    ...
    private final List<Class<? extends YamcsObject<?>>> itemTypes = Arrays.asList(
         YamcsServer.class, YamcsInstance.class
    );
        ...
        treeView.setOnContextMenuRequested(e -> {
        	...
        	if(selectedItem == null) {
        		...
        		if(selectedObject.getObjectType() == "root") {
	                ...
	                setAsDefault.setDisable(true);
	        	} else if(selectedObject.getObjectType() == YamcsInstance.OBJECT_TYPE) {
