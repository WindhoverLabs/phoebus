...
public class ListNumbers {
     ...
     * <p>
     * The ListNumber is not sorted in place, and the data is not copied out. Therefore it's intended that the
     * ListNumber is not changed while the view is used.
     *
     * @param values
    ...
    /**
     * Creates a sorted view of the given ListNumber based on the indexes provided. This method can be used to sort the
     * given values based on the ordering by another (sorted) list of values.
     * <p>
     * The ListNumber is not sorted in place, and the data is not copied out. Therefore it's intended that the
     * ListNumber is not changed while the view is used.
     *
     ...
     *            the values to be sorted
     * @param indexes
     *            the ordering to be used for the view
     * @return the sorted view
     */
     ...
     * <p>
     * Note that, due to rounding errors in double precision, the difference between the elements may not be exactly the
     * same.
     *
     * @param minValue
     ...
     * <p>
     * Always returns true if the list was created with {@link #linearList(double, double, int) } or
     * {@link #linearListFromRange(double, double, int) }. For all other cases, takes the first and last value, creates
     * a linearListFromRange, and checks whether the difference is greater than the precision allowed by double. Note
     * that this method is really strict, and it may rule out cases that may be considered to be linear.
     *
     * @param listNumber
     *            a list number
     ...
     *            must be an array of primitive numbers (byte[], short[], int[], long[], float[] or double[])
     ...
     *            a numeric list
     * @param indexes
     *            the indexes with the values to expose
