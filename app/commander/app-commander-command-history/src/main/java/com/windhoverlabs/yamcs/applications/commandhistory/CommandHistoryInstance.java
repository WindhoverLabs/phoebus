...
public class CommandHistoryInstance implements AppInstance {
  private static final String YAMCS_EVENTS_MEMENTO_FILENAME = "yamcs_events_memento";

  /** Logger for all file browser code */
  public static final Logger logger =
      Logger.getLogger(CommandHistoryInstance.class.getPackageName());

  /** Memento tags */
  private static final String YAMCS_EVENTS = "yamcs_events", YAMCS_EVENT_MESSAGE = "message";

  static CommandHistoryInstance INSTANCE;

  private CommandHistoryController eventInstanceController = null;

  private final AppDescriptor app;

  private DockItem tab = null;

  public CommandHistoryInstance(AppDescriptor app) {
    this.app = app;
    Node content = null;
    ResourceBundle resourceBundle = NLS.getMessages(Messages.class);
    FXMLLoader loader = new FXMLLoader();
    loader.setResources(resourceBundle);
    loader.setLocation(this.getClass().getResource("CommandHistoryView.fxml"));
  ...
  public CommandHistoryController getController() {
