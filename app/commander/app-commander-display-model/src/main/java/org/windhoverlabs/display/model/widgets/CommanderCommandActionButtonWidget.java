...
public class CommanderCommandActionButtonWidget extends VisibleWidget
{
    ...
    private static final WidgetPropertyDescriptor<String> propValue =
            CommonWidgetProperties.newStringPropertyDescriptor(WidgetPropertyCategory.RUNTIME, "value", Messages.WidgetProperties_Value);
    ...
    public static class PvArgProperty extends StructuredWidgetProperty
    {
        ...
        {
            super(propPv, widget,
                  Arrays.asList(propPVName.createProperty(widget, ""),
                                propValue.createProperty(widget, ""),
                                propCommandArgument.createProperty(widget, "")));
        }

        public WidgetProperty<String> pv()            { return getElement(0); }
        public WidgetProperty<VType> value()          { return getElement(1); }
        public WidgetProperty<String> argumentName()  { return getElement(2); }
    };
    
    /** 'Arguments' array */
    private static final ArrayWidgetProperty.Descriptor<PvArgProperty> propPVs =
        new ArrayWidgetProperty.Descriptor<>(WidgetPropertyCategory.MISC, "argument", "Arguments",
                                             (widget, index) -> new PvArgProperty(widget, "Argument " + index),
                                             0);

    /** Widget descriptor */
    public static final WidgetDescriptor WIDGET_DESCRIPTOR =
            new WidgetDescriptor("commander_command_action_button", WidgetCategory.CONTROL,
                    "Command Action Button",
                    "/icons/action_button.png",
                    "Button that can send commands to Commander")
    {
        @Override
        public Widget createWidget()
        {
            return new CommanderCommandActionButtonWidget();
        }
    };
    ...
    private static class ActionButtonConfigurator extends WidgetConfigurator
    {
                ...
                throws Exception
        {
            ...
            final CommanderCommandActionButtonWidget button = (CommanderCommandActionButtonWidget)widget;
...
//            }
    ...
    public CommanderCommandActionButtonWidget()
    {
        ...
        System.out.println("resource location:" + CommanderCommandActionButtonWidget.class.getResource("widget_models/classes.bcf"));
    }
    ...
    protected void defineProperties(final List<WidgetProperty<?>> properties)
    {
        ...
        properties.add(command = CommonWidgetProperties.propCommand.createProperty(this, "command_name"));
