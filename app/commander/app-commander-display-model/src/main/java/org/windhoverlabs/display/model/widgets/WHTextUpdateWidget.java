...
public class WHTextUpdateWidget extends PVWidget
{
    ...
    public static final WidgetDescriptor WIDGET_DESCRIPTOR =
        new WidgetDescriptor("windhover_textupdate", WidgetCategory.MONITOR,
    ...
    private static class CustomWidgetConfigurator extends WidgetConfigurator
    {
                                        ...
                                        final Element xml) throws Exception
        {
            ...
            if (xml_version.getMajor() < 2)
            {
                ...
                WHTextUpdateWidget.readLegacyFormat(xml, text_widget.format, text_widget.precision, text_widget.propPVName());
