...
/**
 * Formats a data type to a String representation. This class provide default implementations that
 * can format scalars and arrays to an arbitrary precision and a maximum number of array elements.
 */
...
public abstract class ValueFormat extends Format {
  ...
  /**
   * Formats the given data object. For scalars and arrays redirects to the appropriate methods. For
   * anything else uses Object.toString().
   *
  ...
  /**
   * Returns the NumberFormat used to format the numeric values. If null, it will use the
   * NumberFormat from the value Display.
   *
  ...
  /**
   * Changes the NumberFormat used to format the numeric values. If null, it will use the
   * NumberFormat from the value Display.
   *
   ...
   *
   * <p>This function will parse the string based on the object provided as a reference (e.g. if
   * reference is a VDouble, it will parse the string as a double). The data in the reference will
   * also be used for the actual parsing (e.g. if reference is Enum, the labels will be used to
   * match the string).
   *
   ...
   *
   * <p>Default implementation uses {@link Double#parseDouble(java.lang.String) }
   *
   * @param source the text to parse
   * @return the parsed representation
   */
   ...
   *
   * <p>Default implementation uses {@link Float#parseFloat(java.lang.String) }
   *
   * @param source the text to parse
   * @return the parsed representation
   */
   ...
   *
   * <p>Default implementation uses {@link Integer#parseInt(java.lang.String) }
   *
   * @param source the text to parse
   * @return the parsed representation
   */
   ...
   *
   * <p>Default implementation uses {@link Short#parseShort(java.lang.String) }
   *
   * @param source the text to parse
   * @return the parsed representation
   */
   ...
   *
   * <p>Default implementation uses {@link Byte#parseByte(java.lang.String) }
   *
   * @param source the text to parse
   * @return the parsed representation
   */
   ...
   *
   * <p>Default implementation returns the string.
   *
   * @param source the text to parse
   * @return the parsed representation
   */
   ...
   *
   * <p>Default implementation matches the label and returns the index.
   *
   * @param source the text to parse
   ...
   *
   * <p>Default implementation expects a comma separated list, and parses each element with {@link
