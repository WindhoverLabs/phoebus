...
public class VColumn {
  ...
  public static VColumn from(VTable table, int index) {
    return new VColumn(
        table.getColumnName(index), table.getColumnType(index), table.getColumnData(index));
  }
  ...
  public static Object combineData(
      Class<?> type, int size, ListInt offsets, List<VColumn> columns) {
    ...
    throw new UnsupportedOperationException(
        "Type " + type + " not supported for column combineData");
  }

  private static Object combineStringData(
      final int size, final ListInt offsets, final List<VColumn> columns) {
  ...
  private static Object combineDoubleData(
      final int size, final ListInt offsets, final List<VColumn> columns) {
