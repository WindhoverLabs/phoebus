...
public class ListMath {
   ...
   * Returns a sublist of the given data.
   *
   * <p>TODO: this should go as a member method
   *
   * @param data a list
   * @param start start point for the sublist
   * @param end end point (exclusive) for the sublist
   ...
   */
  public static ListDouble rescale(
      final ListNumber data, final double factor, final double offset) {
    if (factor == 1.0) {
   ...
   */
  public static ListDouble inverseRescale(
      final ListNumber data, final double numerator, final double offset) {
    return new ListDouble() {
  ...
  /**
   * Returns a list where each element is the sum of the elements of the two lists at the same
   * index. The lists have to match in size.
   *
  ...
  /**
   * Returns a list where each element is the difference of the elements of the two lists at the
   * same index. The lists have to match in size.
   *
   * @param data1 a list of numbers
   * @param data2 another list of numbers
   * @return result[x] = data1[x] - data2[x]
  ...
  public static ListDouble subtract(final ListNumber data1, final ListNumber data2) {
    if (data1.size() != data2.size()) {
      throw new IllegalArgumentException(
          "Can't subtract ListNumbers of different size ("
              + data1.size()
              + " - "
              + data2.size()
              + ")");
  ...
  /**
   * Returns a list where each element is the product of the elements of the two lists at the same
   * index. The lists have to match in size.
   *
   * @param data1 a list of numbers
   * @param data2 another list of numbers
  ...
  /**
   * Returns a list where each element is the division of the elements of the two lists at the same
   * index. The lists have to match in size.
   *
   * @param data1 a list of numbers
   * @param data2 another list of numbers
