...
public enum VImageDataType {
  ...
  /**
   * Is this an integer (signed or unsigned). true if byte, short, int, long, ubyte, ushort, uint,
   * or ulong.
   *
   * @return true if it is an integer type
   */
  public boolean isInteger() {
    if ((ordinal() >= VImageDataType.pvByte.ordinal())
        && (ordinal() <= VImageDataType.pvULong.ordinal())) {
      return true;
    }
    return false;
  }
  ...
  public boolean isUInteger() {
    if ((ordinal() >= VImageDataType.pvUByte.ordinal())
        && (ordinal() <= VImageDataType.pvULong.ordinal())) {
      return true;
    }
    return false;
   ...
   *
   * @return true if the type is a Java numeric type. The numeric types are byte, short, int, long,
   *     float, and double.
   */
  public boolean isNumeric() {
    if ((ordinal() >= VImageDataType.pvByte.ordinal())
        && (ordinal() <= VImageDataType.pvDouble.ordinal())) {
      return true;
    }
    return false;
  }
   ...
   *
   * @return true if the type is a Java primitive type. The numeric types and boolean are primitive
   *     types.
   */
  public boolean isPrimitive() {
    ...
    if (ordinal() == VImageDataType.pvBoolean.ordinal()) {
      return true;
    }
    return false;
  }
  ...
  public static VImageDataType getVImageDataType(String type) {
    if (type.equals("boolean")) {
      return VImageDataType.pvBoolean;
    }
    if (type.equals("byte")) {
      return VImageDataType.pvByte;
    }
    if (type.equals("short")) {
      return VImageDataType.pvShort;
    }
    if (type.equals("int")) {
      return VImageDataType.pvInt;
    }
    if (type.equals("long")) {
      return VImageDataType.pvLong;
    }
    if (type.equals("ubyte")) {
      return VImageDataType.pvUByte;
    }
    if (type.equals("ushort")) {
      return VImageDataType.pvUShort;
    }
    if (type.equals("uint")) {
      return VImageDataType.pvUInt;
    }
    if (type.equals("ulong")) {
      return VImageDataType.pvULong;
    }
    if (type.equals("float")) {
      return VImageDataType.pvFloat;
    }
    if (type.equals("double")) {
      return VImageDataType.pvDouble;
    }
    if (type.equals("string")) {
      return VImageDataType.pvString;
    }
    return null;
  }
