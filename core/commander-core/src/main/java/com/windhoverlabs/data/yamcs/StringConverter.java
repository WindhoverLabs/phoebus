...
public class StringConverter {
  ...
  public static String toString(Value rv) {
    switch (rv.getType()) {
      ...
      case AGGREGATE:
        ...
        return "{"
            + IntStream.range(0, agg.getNameCount())
  ...
  /**
   * Convert a hex string into a byte array. If the string has an odd number of hex digits, it is
   * padded with 0 at the <b>beginning</b>.
   *
