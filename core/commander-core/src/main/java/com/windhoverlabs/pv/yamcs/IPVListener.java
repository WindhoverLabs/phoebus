...
public interface IPVListener {
  ...
  //
  //    /**
  //     * Will be called when connection state changed. It the connection is closed by explicitly
  // calling
  ...
  //
  //    /**
  //     * If no {@link ExceptionHandler} was given to the PV, this method will be called when
  // exception happened.
  ...
  //     * <b>Note:</b> when this is called, the value of the pv may not update yet, which depends
  // the max update rate, so
  ...
  //
  //    /**
  //     * Will be called when write permission <b>may</b> have changed. The write permission can be
  // get from
