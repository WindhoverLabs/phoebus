...
public enum VImageType {
    ...
    TYPE_YUV411,
    /**
     * An image with 8-bit RGB color components, corresponding to a Windows-style BGR color model with the colors Blue,
     * Green, and Red stored in 3 bytes.
     */
    TYPE_3BYTE_BGR,
    /**
     * Represents an image with 8-bit RGBA color components with the colors Blue, Green, and Red stored in 3 bytes and 1
     * byte of alpha.
     */
    TYPE_4BYTE_ABGR,
    /**
    ...
    TYPE_INT_ARGB_PRE,
    /**
     * Represents an image with 8-bit RGB color components, corresponding to a Windows- or Solaris- style BGR color
     * model, with the colors Blue, Green, and Red packed into integer pixels.
     * 
     */
    TYPE_INT_BGR,
    /**
