...
//			super.stop(context);
	...
	/**
	 * Formats a Yamcs instant. Timezone information is not added. Must be called on
	 * SWT thread due to reuse of dateformatter.
	 */
	...
	/**
	 * Formats a Yamcs instant. Must be called on SWT thread due to reuse of
	 * dateformatter.
	 *
